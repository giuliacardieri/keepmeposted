...
<?php $category=filter_input(INPUT_GET, 'category', FILTER_SANITIZE_STRING); 
      if (!$category) { 
        header( 'Location: ' . SITE_DIR); 
        exit; 
      } 
      $postcards=repository::getPostcardCategory($category); ?>
    ...
    <div class="content">
      ...
      <main class="row">
        <div class="main-container">
          <h2>Categories - <?php echo $categories[$category]; ?></h2> 
          ...
          <?php foreach ($postcards as $postcard): ?>
              <?php  if ($postcard->category == $category): ?>
          ...
          <?php else: ?>
          <p>This category has no postcards yet!</p>
          <?php endif; ?>
