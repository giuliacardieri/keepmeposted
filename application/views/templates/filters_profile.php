<div class="row">
	<div class="col-md-9 search-row">	
		...
		<div class="col-xs-12 col-sm-12 col-md-12">
			<div class="row">
				<form class="hidden-xs hidden-sm" id="filters-form" method="post" data-href="<?php echo site_url('profile/reload/' . $username); ?>">
					<div class="row">
...
<div class="col-md-12 postcards-wrapper-smaller">
